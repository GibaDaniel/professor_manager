...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "professormanager/test/integration/FirstJourney",
    "professormanager/test/integration/ProfessorListJourney",
    "professormanager/test/integration/ProfessorObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
